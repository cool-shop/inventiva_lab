    ...
    return (
        <div className={`fixed bottom-0 left-0 right-0 z-50 px-6 pb-6 pointer-events-none transition-opacity duration-300 ${isHidden ? 'opacity-0' : 'opacity-100'}`}>
            ...
            >
                ...
                >
                    {/* <ShoppingBag size={32} /> */}
                    <img src={APP_CONFIG.LOGO_SM} alt="Inventiva" className="w-16 h-16 sm:w-24 sm:h-24 rounded-full shadow-2xl shadow-cat-orange/40 -mt-20 text-white cursor-pointer hover:rotate-12 hover:scale-110 active:scale-90 transition-all font-black" />
                </div>
                <button
